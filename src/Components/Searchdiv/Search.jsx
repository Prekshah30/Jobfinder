    ...
    <div className="searchDiv grid gp-10 bg-greyIsh rounded-[10px] p-[3rem]">
      ...
      <div className="secDiv flex items-center gap-10 justify-center">
        <div className="singleSearch flex items-center gap-2">
          <label htmlFor="relevance" className="text-blueColor font-semibold py-4">
            Sort by:
          </label>
        ...
        <div className="singleSearch flex items-center gap-2">
          <label htmlFor="type" className="text-blueColor font-semibold py-4">
            Type:
          </label>
        ...
        <div className="singleSearch flex items-center gap-2">
          <label htmlFor="level" className="text-blueColor font-semibold py-4">
            Level:
          </label>
